  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <link href="assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
       <style>
        ...
        #result {width: 400px ; padding: 10px ; margin: 0 auto ; border: 1px solid orange ; display: none ; margin-left: -40px ;background: white ; position: absolute}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-4">
                                <ul>
                                    <li class="header-support">
                                        <a href="#" title=""><span class="fa fa-phone "></span> 24/7 Free Support</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- / support -->
                            ...
                            <div class="col-md-3 col-lg-3 hidden-sm">
                                <div class="header-message">
                                    <p>Our Periority our satisfacion ! </p>
                                </div>
                            </div>
                            <!-- / message -->
                            <!-- Counntry -->
                                ...
                                <div class="header-search">
                                    <form id="searchbox" action="#" method="post">
                                        <div class="form-search">
                                            <input class="form-control font-capitalize" type="text" placeholder="Enter your keyword..." id="searchp">
                            ...
                            <div  style="position:absolute ; margin-left:820px ; margin-top:14px">
                                ...
                                <?php
						            ...
						            else
						            {
                                        ...
                                        echo "<img src='customer\customer_photos\$cus_image'  class='img-circle' height='45' style='border:2px solid #016579'>
                                        <span>$cus_name </span>";
						            }
                                ?>
                            </div>
                                    ...
                                    <div class="topcart-mini-container">
                                        <div class="block-cart">
                                            <button class="dropdown-toggle" type="button">
                                                ...
                                                <span class="cart-top-title" >Shopping Cart <span style="margin-left:37px ; color:white ; font-size:16px"> </span> </span>
                                            </button>
                                            ...
                                            <ul class="cart-product-list sfmenuffect">
                                                ...
                                                <li class="item cart-item">
                                                    <div class="top-subtotal">
                                                        <div class="sub-total">
                                                            <label>Sub-Total:</label><span></span>
                                                        </div>
                                                         <div class="sub-total">
                                                        ...
                                                        <div class="buttons">
                                                            <div class="float-right">
                                                                ...
                                                                <a class="btn btn-button lagoon-blue-bg white checkout" href="checkout.html">checkout</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
